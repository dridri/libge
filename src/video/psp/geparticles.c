...
static ge_Vertex _ge_particles_vertices[6] = {
	{ 0.0, 0.0, 0xFFFFFFFF, 0.0, 0.0, 1.0,-0.5,-0.5, 0.0 },
	{ 1.0, 0.0, 0xFFFFFFFF, 0.0, 0.0, 1.0, 0.5,-0.5, 0.0 },
	{ 0.0, 1.0, 0xFFFFFFFF, 0.0, 0.0, 1.0,-0.5, 0.5, 0.0 },

	{ 0.0, 1.0, 0xFFFFFFFF, 0.0, 0.0, 1.0,-0.5, 0.5, 0.0 },
	{ 1.0, 0.0, 0xFFFFFFFF, 0.0, 0.0, 1.0, 0.5,-0.5, 0.0 },
	{ 1.0, 1.0, 0xFFFFFFFF, 0.0, 0.0, 1.0, 0.5, 0.5, 0.0 }
};
...
ge_Particles* geCreateParticles(float x, float y, float z, float radius, float velocity, float life_time, int nParticles, ge_Image* texture){
	...
	particles->render = geCreateRenderer(NULL);
